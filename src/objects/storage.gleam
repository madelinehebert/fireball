...
pub fn json_to_upload_data(
  ...
  let upload_data_decoder =
    decode15(
      ...
      field(named: "contentType", of: dynamic.string),
      field(named: "timeCreated", of: dynamic.string),
      field(named: "updated", of: dynamic.string),
      field(named: "storageClass", of: dynamic.string),
      field(named: "size", of: dynamic.string),
      field(named: "md5Hash", of: dynamic.string),
      field(named: "contentEncoding", of: dynamic.string),
      field(named: "contentDisposition", of: dynamic.string),
      field(named: "crc32c", of: dynamic.string),
      field(named: "etag", of: dynamic.string),
      field(named: "downloadTokens", of: dynamic.string),
    )
